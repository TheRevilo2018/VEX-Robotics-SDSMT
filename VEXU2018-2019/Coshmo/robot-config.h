...
vex::motor rightMotor1 (vex::PORT10, vex::gearSetting::ratio18_1, true);
vex::motor leftMotor2 (vex::PORT2, vex::gearSetting::ratio18_1, false);
vex::motor rightMotor2 (vex::PORT11, vex::gearSetting::ratio18_1, true);
vex::motor leftMotor3 (vex::PORT3, vex::gearSetting::ratio18_1, false);
vex::motor rightMotor3 (vex::PORT12, vex::gearSetting::ratio18_1, true);
