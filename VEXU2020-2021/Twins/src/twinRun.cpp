...
void autonomousTaskBeta(void * param)
{
    ...
    pros::delay(1000);
    driveBase->swingDrivePID(-0.5, 0);
    driveBase->turnDegreesAbsolutePID(188);
    driveBase->swingDrivePID(2, 0);
