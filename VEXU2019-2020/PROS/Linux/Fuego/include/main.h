...
//1 10, 11, 20
//Motor port defines
#define LEFT_WHEEL_MIDDLE_PORT 1
#define LEFT_LIFT_TOP_PORT 2
#define LEFT_WHEEL_TOP_PORT 3
//4
#define LEFT_TRAY_PORT 5

#define RIGHT_TRAY_PORT 6
//7
#define RIGHT_WHEEL_TOP_PORT 8
#define RIGHT_LIFT_TOP_PORT 9
#define RIGHT_WHEEL_MIDDLE_PORT 10

#define LEFT_WHEEL_BOTTOM_PORT 11
#define LEFT_INTAKE_1_PORT 12
#define LEFT_LIFT_BOTTOM_PORT 13
//14
#define LEFT_INTAKE_2_PORT 15

#define RIGHT_INTAKE_2_PORT 16
//17
//18
#define RIGHT_LIFT_BOTTOM_PORT 18
#define RIGHT_INTAKE_1_PORT 19
#define RIGHT_WHEEL_BOTTOM_PORT 20

#define DEBOUNCE_DELAY 200
#define KILL_BUTTON pros::E_CONTROLLER_DIGITAL_UP
#define TRAY_MAX_HEIGHT 500
#define TRAY_MIDDLE_HEIGHT 360
...
static pros::Motor wheelLeft2(LEFT_WHEEL_MIDDLE_PORT, pros::E_MOTOR_GEARSET_18, false, pros::E_MOTOR_ENCODER_COUNTS);
...
static pros::Motor liftLeft1(LEFT_LIFT_TOP_PORT, pros::E_MOTOR_GEARSET_18, true, pros::E_MOTOR_ENCODER_DEGREES);
static pros::Motor liftLeft2(LEFT_LIFT_BOTTOM_PORT, pros::E_MOTOR_GEARSET_18, true, pros::E_MOTOR_ENCODER_DEGREES);
static pros::Motor liftRight1(RIGHT_LIFT_TOP_PORT, pros::E_MOTOR_GEARSET_18, false, pros::E_MOTOR_ENCODER_DEGREES);
static pros::Motor liftRight2(RIGHT_LIFT_BOTTOM_PORT, pros::E_MOTOR_GEARSET_18, false, pros::E_MOTOR_ENCODER_DEGREES);
...
static std::vector<pros::Motor> liftMotors = {liftLeft1, liftLeft2, liftRight1, liftRight2};

//position constants
static std::vector<int> liftPositions = {1300, 1800};
static std::vector<int> trayPositions = {150, 360};
