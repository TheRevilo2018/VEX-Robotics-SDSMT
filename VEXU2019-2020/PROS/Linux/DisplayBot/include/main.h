...
static pros::Motor wheelLeft(LEFT_WHEEL_TOP_PORT, pros::E_MOTOR_GEARSET_18, false, pros::E_MOTOR_ENCODER_COUNTS);
static pros::Motor wheelRight(RIGHT_WHEEL_MIDDLE_PORT, pros::E_MOTOR_GEARSET_18, true, pros::E_MOTOR_ENCODER_COUNTS);

//3 wire port declearations

//motor grouping declarations
static std::vector<pros::Motor> wheelMotorVector = {wheelLeft, wheelRight};
static std::vector<pros::Motor> leftWheelMotorVector = {wheelLeft };
static std::vector<pros::Motor> rightWheelMotorVector = {wheelRight };
